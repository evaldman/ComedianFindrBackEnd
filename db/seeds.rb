...
bio: "Dave Chappelle is an American stand-up comedian. With his incisive observations, he has been described as 'poetically unfiltered' and 'sociopolitically introspective,' with an ability to illuminate and interrogate agonizing and poignant topics.", 
...
user1 = User.create(username: "user_1")
...
review4 = Review.create(user: user1, comic: gadsby, content: "Though provoking and hilarious!")
